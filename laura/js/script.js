let CONFIG = {
  ...
  commands: [
    ...
    },
    {
      ...
      key: '',
      url: 'https://gmail.com',
      color: 'linear-gradient(135deg, #DB4437, #0F9D58)',
      icon: 'mail',
      quickLaunch: false,
    },
    {
    ...
    },
    {
      ...
      color: 'linear-gradient(135deg, #154733, #a9a9a9)',
      icon: 'canvas',
      quickLaunch: false,
    },
    {
    ...
    },
    {
      ...
      name: 'NOAA NWS',
      key: '',
      url: 'https://forecast.weather.gov/MapClick.php?lat=44.053&lon=-123.1122',
