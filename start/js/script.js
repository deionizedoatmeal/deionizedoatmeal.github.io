let CONFIG = {
  ...
  commands: [
    ...
    },
    {
      ...
      key: '',
      url: 'https://gmail.com',
      color: 'linear-gradient(135deg, #4285F4, #DB4437, #0F9D58)',
      icon: 'mail',
      quickLaunch: true,
    },
    {
    ...
    },
    {
      ...
      color: 'linear-gradient(135deg, #A9A9A9, #FF4FFF)',
      icon: 'apod',
      quickLaunch: true,
    },
    {
    ...
    },
    {
      ...
      color: 'linear-gradient(135deg, #dd1100, #FBBC05)',
      icon: 'keep',
      quickLaunch: false,
    },
    {
    ...
    },
    {
      ...
      search: '/input/?i={}',
      color: 'linear-gradient(135deg, #dd1100, #ff7d00)',
      icon: 'wolfram',
      quickLaunch: false,
    },
    {
    ...
    },
    {
      ...
      color: 'linear-gradient(135deg, #3d3d3d, #5A646E)',
      icon: 'mesa',
      quickLaunch: false,
    },
    {
    ...
    },
    {
      ...
      color: 'linear-gradient(135deg, #64d44c, #3d6646)',
      icon: 'gaia',
      quickLaunch: false,
    },
    {
